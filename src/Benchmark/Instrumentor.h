...
namespace Benchmark {
    ...
    public:
        ...
        void beginSession(const std::string &name, const std::string &filepath = "/home/lucas/tmp/results.json") {
    ...
    public:
        ...
        void stop() {
            ...
            m_result.end = std::chrono::time_point_cast<std::chrono::microseconds>(endTimepoint).time_since_epoch().
                    count();
